      ...
      <div className="gray">
        ...
        <div className="blue">
          ...
          from amine systems due to solids."
            ...
            />
            <h5>
              FINE PARTICULATES IN PRODUCT / WHITE FUELS FILTRATION / TANK FARM
              PRODUCT FILTER
            </h5>
            <p>
              Suspended solids in the final refinery product/white fuels lead to
            ...
            <h5>
              CATALYST BED PROTECTION (DHDS/NHT/DHDT/MERCURY GUARD BED ETC.)
            </h5>
            <p>
            ...
            <p>
              Compressed air used in plants for process sensitive instruments
            ...
            <p>
              Plate heat exchangers are sensitive to solid contamination.
